   ...
   // const { text, activeChatId } = req.body;
    ...
    //const response = await openai.createChatCompletion({
     // model: "gpt-3.5-turbo",
       ...
       // and the bot can use that information to respond to the user as needed, ie adding:         // { role: "assistant", content: "The weather sucks today." },
...
//         // messages that the bot sends and then provide them to the bot in the next request.
   ...
   // });
    ...
    //   `https://api.chatengine.io/chats/${activeChatId}/messages/`,
     ...
     // {         headers: {           "Project-ID": process.env.PROJECT_ID,
